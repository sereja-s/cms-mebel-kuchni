				...
				<div class="cart-page__get-contacts">
					...
					<div class="cart-page__gс-form">
						<div class="cart-page__gc-item-check">
							<label><input type="checkbox" required>&nbsp;&nbsp;Я даю Согласие на обработку персональных данных в порядке и на условиях, указанных в Политике конфиденциальности</label>

							<?php if (!empty($this->menu['information'])) : ?>

								<div class="cart__info" style="display: flex; flex-direction: column; margin: 1em auto;">

									<?php foreach ($this->menu['information'] as $item) : ?>

										<?php if ($item['alias'] === 'politika-konfidentsialnosti' || $item['alias'] === 'soglasie-na-obrabotku-personalnyh-dannyh-polzovatelya-sayta') : ?>

											<a class="footer__nav-link cart__info-link" href="<?= $this->alias(['information' => $item['alias']]) ?>"><?= $item['name'] ?></a>
